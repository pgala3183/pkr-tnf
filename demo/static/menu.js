...
var button_transformer = document.getElementById('play_with_transformer');
...
function updateOpponentInfo() {
    ...
    switch (selectedOpponent) {
        case "bot":
            ...
            document.getElementById('opponent-transformer').hidden = true;
        ...
        case "gpt":
            ...
            break;
        case "transformer":
            opponentName.textContent = "Transformer Bot";
            opponentDescription.textContent = "Play vs. your trained poker-transformer model served over FastAPI (quantized ONNX at localhost:8000).";
            document.getElementById('opponent-bot').hidden = true;
            document.getElementById('opponent-ai').hidden = true;
            document.getElementById('opponent-gpt').hidden = true;
            document.getElementById('opponent-transformer').hidden = false;
            button_transformer.classList.add('selected_button');
            break;
        default:
            break;
    }
